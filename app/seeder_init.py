...
def seeder():
    ...
    setting = [
        Setting(id=1, logoFilePath='./static/asset/logo/logo2.jpg', logoHeight=60, logoWidth=60, stampFilePath='./static/asset/stamp/inkan.png', stampHeight=60, stampWidth=60,
                isDisplayQuotationLogo=True, isDisplayInvoiceLogo=True, isDisplayDeliveryLogo=True, isDisplayQuotationStamp=True, isDisplayInvoiceStamp=True, isDisplayDeliveryStamp=True,
                defaultTax=10, isHideTabletMode=False)
    ]
